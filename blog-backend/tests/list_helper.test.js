...
describe('mostBlogs', () => {
  test('given list of many blogs then returns author with largest amount of blogs and number of blogs', () => {
  ...
  test('given list with one blog the return author of said blog with number of blogs', () => {
    const listWithOneBlog = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
...
describe('mostLikes', () => {
  test('given list with many blogs should return author with most likes and amount of likes', () => {
    const listWithManyBlogs = [
      {
        _id: '5a422a851b54a676234d17f7',
        title: 'React patterns',
  ...
  test('given list with one blog then return author of said blog with amount of likes', () => {
    const listWithOneBlog = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
  ...
  test('given empty list then should throw TypeError', () => {
    const emptyList = []
    expect( () => { listHelper.mostLikes(emptyList) } ).toThrow(TypeError)
  })
})